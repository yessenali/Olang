...
<body>
    <header class="header"> 
        <div class="header_top">
            <div class="container">
                                ...
                                <ul class="navbar nav ml-auto">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="kz">
                                            <img width="20" src="{{public('img/kz.png')}}">Қазақ тілі</a><br>
                                            <a class="dropdown-item" href="ru">
                                            <img width="20" src="{{public('img/ru.png')}}">Русский язык</a>
                ...
                <a  data-fancybox data-src="#modal" href="javascript:;" class="header_btn" href="#">Тегін консультация</a>
            </div>
         </div>
        </div>
            ...
            <div class="slider_inner">
                <div class="slider_item">
                    ...
                    <div class="slider_title">
                        Olang ағылшын тілі онлайн курс платформасы
                    </div>
    ...
    <footer class="footer">
            ...
            <div class="container">
                ...
                <div class="footer_info">
                    ...
                    <ul class="footer_list">
                        ...
                        <li><a class="footer_adress" href="#">Жетісай а, Асықата мектебі</a></li>
                    </ul>
                </div>
        ...
        <div class="footer_copy">
            <div class="container">
                <div class="footer_text">
                    © 2021 Template by Yessenali Zhanaidar. Все права защищены.
                </div>
            </div>
        </div>
    </footer>
